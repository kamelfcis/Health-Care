...
import { Building2, Calendar, CalendarClock, ClipboardList, CreditCard, LayoutDashboard, Megaphone, Pill, Settings, Stethoscope, TrendingUp, UserCog, Users, Wallet } from "lucide-react";
...
export default function DashboardPage() {
  ...
  const quickActionConfig = useMemo<QuickActionConfig[]>(
    () => [
      ...
      {
        href: "/dashboard/campaigns-lookup",
        labelKey: "nav.campaignsLookup",
        icon: Megaphone,
        allowedRoles: ["SuperAdmin", "ClinicAdmin"]
      },
      {
      ...
      { href: "/procedures", labelKey: "nav.procedures", icon: ClipboardList, requiredPermission: "billing.manage" },
